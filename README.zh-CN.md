...
| 设计 | [`design`](skills/design/SKILL.md) | 基于参考 app 方向、quick-fix 和截图模式、生成图片资产指导、原生动效映射和真实渲染验证，构建有辨识度的 UI。 |
...
| `codex-dynamic-workflows` | 外部 skill，来源：[`DannyMac180/skills`](https://github.com/DannyMac180/skills/tree/5695fa19b9d39b8270025e79633b49a8b863f9a2/codex-dynamic-workflows)，MIT License。 |
...
| `design` | 本地 UI 设计工作流，在保留 `design` 名称的前提下同步 Waza 的 `ui` 更新，并扩展了参考 app 方向锁定和 [`VoltAgent/awesome-design-md`](https://github.com/VoltAgent/awesome-design-md) 品牌 preset 拆解。 |
