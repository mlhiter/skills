...
For non-trivial architecture, product, workflow, production-impacting, or ambiguous implementation plans, run a first-principles pass before proposing the approach.

State the mechanism-level basis in 3-5 short bullets:

- What invariant or user outcome must the system preserve?
- What is the source of truth and which boundary owns it?
- Which assumptions are unverified or imported from analogy?
